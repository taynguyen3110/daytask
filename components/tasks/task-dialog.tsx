  ...
  useEffect(() => {
    if (open) {
      if (task) {
        ...
        setTitle("")
        setDescription("")
        setDueDate(defaultDate ? new Date(defaultDate) : undefined)
        setPriority("medium")
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <Select value={recurrence || ""} onValueChange={(value) => setRecurrence(value || undefined)}>
            ...
            <div className="grid gap-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className={cn("justify-start text-left font-normal", !reminder && "text-muted-foreground")}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
