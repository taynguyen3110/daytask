...
import { ArrowLeft, Calendar, Bell, Repeat, Tag, AlarmClock, Edit, Trash2 } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Checkbox checked={task.completed} onCheckedChange={handleToggleComplete} className="h-5 w-5" />
          <h1 className={cn("text-2xl font-bold tracking-tight", task.completed && "line-through opacity-70")}>
            {task.title}
          </h1>
        </div>
